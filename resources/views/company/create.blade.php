        ...
        <div class="card-box">
                    ...
                    <div class="form-group">
                        ...
                        <div id="filesinput">
                            ...
                            <div class="wrap-custom-file">
                                <input type="file" name="brand_" id="image1" accept=".gif, .jpg, .png"/>
                                <label for="image1"
            ...
            <div class="row">
                <div class="col-xs-12 text-right">
                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> {{ __("company.create") }}</button>
                </div>
            </div>
            {{ Form::close() }}
        </div>
